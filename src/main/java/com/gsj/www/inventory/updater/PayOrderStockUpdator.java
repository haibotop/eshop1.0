 ...
 * 支付订单库存更新组件
 */
public class PayOrderStockUpdator extends AbstractGoodsStockUpdater {
    /**
     * 订单条目DTO对象集合
     */
     ...
     */
    public PayOrderStockUpdator(List<GoodsStockDO> goodsStockDOS, GoodsStockDAO goodsStockDAO, DateProvider dateProvider,Map<Long, OrderItemDTO> orderItemDTOMap) {
